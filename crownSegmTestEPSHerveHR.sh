...
#Example call
#bash crownSegmTestEPSHerveHR.sh /media/yago/workDrive/Experiments/forests/treetopDetection/ /media/yago/workDrive/Experiments/forests/treetopDetection/output/ /media/yago/workDrive/Experiments/forests/treetopDetection/Herve/lowres/ ce ONEBAND yes 1
...
echo "method $mosaicString " > $repeatedFile
	...
	#wSizes="500 1000 2500 5000"
	wSizes="2500 5000"
	thresholds="250 500 1000 2000 2500"
	...
	do
		...
		do
			...
			if [[ $compute = 1 ]];then
				...
				echo "python $sourceDir/sliding_windowHIGHRES.py -d" $dataPrefix"/"$i"_chm.tif $params -o $outputFileName -ref $refine -refRad $refineRadius"			
				python $sourceDir/sliding_windowHIGHRES.py -d"$dataPrefix"/"$i"_chm.tif $params -o $outputFileName  -ref $refine -refRad $refineRadius
